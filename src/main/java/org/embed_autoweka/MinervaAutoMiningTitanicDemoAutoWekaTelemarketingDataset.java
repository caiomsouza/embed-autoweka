...
public class MinervaAutoMiningTitanicDemoAutoWekaTelemarketingDataset {

    public static void main(String[] args) throws Exception {

    	String trainData = "dataset/telemarketing2.arff";
    	String testData = "dataset/telemarketing2.arff";
    	String WekaModelSavedFile = "savedmodels/telemarketing-j48.model";    	
    	String AutoWekaModelSavedFile = "savedmodels/telemarketing-autoweka.model";    	
