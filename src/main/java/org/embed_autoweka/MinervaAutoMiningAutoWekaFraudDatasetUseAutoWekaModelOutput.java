...
public class MinervaAutoMiningAutoWekaFraudDatasetUseAutoWekaModelOutput {

    public static void main(String[] args) throws Exception {

    	String trainData = "dataset/fraud.arff";
    	String testData = "dataset/fraud.arff";
    	String WekaModelSavedFile = "savedmodels/fraud-j48.model";    	
    	String AutoWekaModelSavedFile = "savedmodels/fraud-autoweka.model";    	
    	String AutoWekaModelSavedFile2 = "savedmodels/fraud-autoweka2.model";  
...
//        cls.buildClassifier(train);
     ...
     // deserialize model
        ...
        System.out.println("---------- Starting Auto Weka...");  
...
// areaUnderROC
        ...
        System.out.println("---------- Finished Auto Weka...");  
     ...
     // serialize model (Save Model to File)
        ObjectOutputStream oosAutoWekaModel2 = new ObjectOutputStream(new FileOutputStream(AutoWekaModelSavedFile2));
        oosAutoWekaModel2.writeObject(classifier);
        oosAutoWekaModel2.flush();
        oosAutoWekaModel2.close();
        
        System.out.println("---------- Model Saved to:" + AutoWekaModelSavedFile2);        
